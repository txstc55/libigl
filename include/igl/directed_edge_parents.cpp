...
{
  static_assert(igl::is_index_matrix<DerivedE>::value, "directed_edge_parents E variable have a scalar of signed integer type");
  static_assert(igl::is_index_matrix<DerivedP>::value, "directed_edge_parents P variable have a scalar of signed integer type");
